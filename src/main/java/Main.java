...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Random random = new Random(987987);
    ...
    private static double distanciaEuclidiana(Exemplar primeira, Exemplar segunda) {

        List<Atributo> atributos = primeira.todosOsAtributos();
        double somaDosQuadradosDasDiferencas = 0.0;

        for (Atributo atributo : atributos) {
            somaDosQuadradosDasDiferencas += Math.pow(primeira.valor(atributo) - segunda.valor(atributo), 2);
        }
